<section id="breadcrumbs" class="breadcrumbs">
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
            ...
            <ol>
                <li><a href="<?php echo site_url(); ?>engineerOrSupervisor" class="btn btn-danger btn-sm">Back</a></li>
...
<section id="team" class="team ">
    <div class="container">
     <form method="post" id="addNewCivilForms" enctype="multipart/form-data">
      <div class="alert alert-danger" id="error_message_register" style="display:none;"></div>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    <label>Your full name (आपका पूरा नाम)<b style="color:red;"> *</b></label>
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    <label>Qualification (योग्यता)<b style="color:red;"> *</b></label>
                    <input type="text" id="qualification" name="qualification" placeholder="eg. Civil Engineer" class="form-control">
                </div>
                <div class="form-group col-md-6">
                    <label>Age (आयु)<b style="color:red;"> *</b></label>
                    <input type="text" id="age" name="age" placeholder="eg. 21" class="form-control">
                </div> 
            </div>
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <textarea rows="2" type="text" id="address" name="address" placeholder="eg. gajanan nagar" class="form-control"></textarea>
                </div> 
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    <label>Your experience Details (आपका अनुभव)</label>
                    <textarea type="text" id="your_experience" name="your_experience" placeholder="eg: 5 Year" class="form-control"></textarea>
                </div>
                <div class="form-group col-md-6">
