...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/images/doindian.png" />
</head>
             ...
             <!-- <div class="brand-logo">
              ...
              <form class="pt-3" method="post" id="loging_submit">
                ...
                <div class="form-group">
                    <input type="text" maxlength="100" class="form-control form-control-lg" id="username" name="username" placeholder="Username">
                </div>
                <div class="form-group">
