            ...
            ?>
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-shopping-bag"></i> Add Driver Type Operator <a href="<?php echo site_url(); ?>driverTypes" class="btn btn-gradient-info btn-sm"> Back <i class="fa fa-refresh"></i></a>
                    </div>
                    <div class="card-body">
                        <form method="post" id="submit_driver_types" enctype="multipart/form-data">
                         ...
                         <label for="url">Driver Type</label>
                           <input type="text" name="type" id="type" placeholder="Driver Type" class="form-control" /> 
                         </div>
    ...
    <div class="card">
        ...
        <table class="table table-bordered">
            ...
            <?php } else { ?>
                <div class="card">
                    <div class="card-header">
                        <i class="mdi mdi-table-large"></i>Driver Types <a href="<?php echo site_url(); ?>driverTypes?add=new" class="btn btn-gradient-info btn-sm"> Add New <i class="fa fa-plus"></i></a>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered" id="driveType_table_list">
                                <thead>
                                    <tr>
                                        <th>Sr.No</th>
                                        <th>Type</th>
